...
var propTypes = {
  ...
  returnHtml: _propTypes2.default.bool,
  htmlToText: _propTypes2.default.func,
  fastUpdate: _propTypes2.default.bool,
  ...
  function ContentEditable(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "setCaret", function () {
      ...
      if (caretPosition && _this._element) {
        ...
        var _offset = value.length && caretPosition === 'end' ? 1 : 0;

        var range = document.createRange();
        var selection = window.getSelection();
        range.setStart(_this._element, _offset);
        range.collapse(true);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_getRawValue", function () {
      var _this$props = _this.props,
          returnHtml = _this$props.returnHtml,
          htmlToText = _this$props.htmlToText;
      var rawValue = returnHtml ? _this._element.innerHTML : _this._element.innerText;
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_onChange", function (ev) {
      var _this$props2 = _this.props,
          ...
          fastUpdate = _this$props2.fastUpdate;

      var rawValue = _this._getRawValue();

      var sanitisedValue = sanitise ? _this.sanitiseValue(rawValue) : rawValue;
      var value = onUpdate ? onUpdate(sanitisedValue) : sanitisedValue;

      if (_this.state.value !== value) {
        if (fastUpdate) {
          var _position = (0, _caretPos.position)(_this._element),
              pos = _position.pos;

          _this._element.innerHTML = onUpdate ? value : rawValue;
          (0, _caretPos.position)(_this._element, pos);
        }

        _this.setState({
          value: value
        }, function () {
          _this.props.onChange(ev, rawValue);
        });
      }
    });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_onBlur", function (ev) {
      var _this$props3 = _this.props,
          sanitise = _this$props3.sanitise,
          onUpdate = _this$props3.onUpdate;

      var rawValue = _this._getRawValue();

      var sanitisedValue = sanitise ? _this.sanitiseValue(rawValue) : rawValue;
      var value = onUpdate ? onUpdate(sanitisedValue) : sanitisedValue; // We finally set the state to the sanitised version (rather than the `rawValue`) because we're blurring the field.

      _this.setState({
        value: value
      }, function () {
        _this.props.onChange(ev, sanitisedValue);
  ...
  _createClass(ContentEditable, [{
    ...
    value: function sanitiseValue(val) {
      var _this$props5 = this.props,
          ...
          sanitise = _this$props5.sanitise;
    ...
    value: function render() {
      ...
      var _this$props6 = this.props,
          Element = _this$props6.tagName,
          content = _this$props6.content,
          editable = _this$props6.editable,
          styled = _this$props6.styled,
          props = _objectWithoutProperties(_this$props6, ["tagName", "content", "editable", "styled"]);
