  ...
  function ContentEditable(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_onChange", function (ev) {
      var _this$props = _this.props,
          sanitise = _this$props.sanitise,
          onUpdate = _this$props.onUpdate;
      var rawValue = onUpdate ? onUpdate(_this._element.innerText) : _this._element.innerText;
  ...
  _createClass(ContentEditable, [{
    ...
    value: function sanitiseValue(val) {
      var _this$props4 = this.props,
          ...
          sanitise = _this$props4.sanitise;
    ...
    value: function render() {
      ...
      var _this$props5 = this.props,
          Element = _this$props5.tagName,
          content = _this$props5.content,
          editable = _this$props5.editable,
          styled = _this$props5.styled,
          props = _objectWithoutProperties(_this$props5, ["tagName", "content", "editable", "styled"]);
